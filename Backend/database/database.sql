...
--
-- Host: 127.0.0.1    Database: libraryroombooking
-- ------------------------------------------------------
...
CREATE TABLE `reservation_members` (
  ...
  CONSTRAINT `reservation_members_ibfk_1` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`reservation_id`)
...
INSERT INTO `users` VALUES (1,'Test User','test@example.com','$2b$10$r.N5Vmii7uunh3CzlBi10uksuEkTJ1pucKL640wsidXYSuhk.V3HG','','','2025-09-25 11:58:16');
...
-- Dump completed on 2025-10-06 13:55:35
